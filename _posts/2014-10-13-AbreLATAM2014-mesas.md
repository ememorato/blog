...
En la mesa de estándares y formatos de datos abiertos se dio una plática muy técnica pero al mismo tiempo muy
...
Para cerrar nuestra experiencia en esta mesa hablamos sobre [Datamx.io](http://datamx.io), en la cual platiqué sobre [nuestro centro de apertura
...
ocurrió alrededor de los casos de uso sobre cuando utilizar una interfaz de programación de aplicaciones y sobre cuando utilizar
